...
export function TeamSection() {
  ...
  const stats = [
    { number: "50+", label: "Team Members", description: "Across 12 countries" },
    { number: "25+", label: "PhD Holders", description: "In AI, CS, and Physics" },
    { number: "100+", label: "Patents Filed", description: "In emerging technologies" },
    { number: "15+", label: "Years Experience", description: "Average team expertise" }
  ];
